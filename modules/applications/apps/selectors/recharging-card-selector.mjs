...
/** @inheritDoc */
export default class RechargingCardSelector extends Selector
{
	/** @inheritDoc */
	constructor(options = {})
	{
	...
	static DEFAULT_OPTIONS = {
		id: "recharging-card-selector-{id}",
		actions: {flip: this.#flip},
		classes: ["recharging-card-selector"],
		window: {title: "RECHARGINGCARDSELECTOR.title"},
		position: {width: 940}
	};
